...
function buildResetPasswordEmail(url: string): string {
	return `
<!DOCTYPE html>
<html>
<head>
		...
		<tr>
			<td align="center">
				<table width="480" cellpadding="0" cellspacing="0" style="background:rgba(41,35,72,0.9);border:1px solid rgba(155,146,201,0.2);border-radius:16px;padding:40px;">
					...
					<tr>
						<td align="center" style="padding-bottom:32px;">
							<p style="margin:0;font-size:14px;color:#94a3b8;">Reset your password</p>
						</td>
					</tr>
					<tr>
						<td align="center" style="padding-bottom:32px;">
	...
	emailAndPassword: {
		...
		sendResetPassword: async ({ user, url }) => {
			await getTransporter().sendMail({
				...
				to: user.email,
				subject: 'Reset your NexusID password',
				html: buildResetPasswordEmail(url)
			});
		}
	},
	user: {
